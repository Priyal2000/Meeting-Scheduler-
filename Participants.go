...
//ParticipantMeeting : Returns all the active meetings of a participant
func ParticipantMeeting(email string) []Meeting {
...
// Participants : Gets all the active meetings for a particiapnt 
func Participants(response http.ResponseWriter, request *http.Request) {
